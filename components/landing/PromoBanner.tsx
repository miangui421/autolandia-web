  ...
  return (
    <div className="max-w-[600px] mx-auto mb-8 px-4 animate-slide-up">
      <button
        ...
        className="w-full relative overflow-hidden bg-gradient-to-r from-[#d4af37]/15 via-[#d4af37]/10 to-[#d4af37]/15 border border-[#d4af37]/40 rounded-2xl p-5 flex items-center gap-4 transition-all hover:border-[#d4af37]/60 hover:shadow-[0_0_30px_rgba(212,175,55,0.15)] group text-left"
      >
        {/* Animated shimmer */}
