    ...
    <div className="min-h-screen">
      <nav className="border-b border-white/5 py-3 px-4">
        <div className="max-w-[720px] mx-auto flex items-center justify-between">
          ...
          <Link
            href="/"
            className="text-xs text-white/50 hover:text-white/80 border border-white/10 hover:border-white/30 px-3 py-1.5 rounded-lg transition-colors"
          >
            ← Volver al inicio
          </Link>
        </div>
      ...
      <div className="max-w-[720px] mx-auto px-4 py-8 space-y-8">
        ...
        <div className="text-center pt-2">
          <Link
            href="/"
            className="inline-block text-xs text-white/50 hover:text-white/80 border border-white/10 hover:border-white/30 px-4 py-2 rounded-lg transition-colors"
          >
            ← Volver al inicio
          </Link>
        </div>
